    ...
    return (
        <>
            ...
            <div className="bg-white min-h-screen mt-28 px-20 text-black text-center font-nastaleeqRegular">
                ...
                <div className="flex flex-col justify-center items-center gap-y-8 py-20">
                    <h1 className="font-nastaleeqKasheeda text-4xl">تربیت اولاد کیوں ضروری ہے؟ </h1>
                ...
                <div className=" w-full flex flex-col justify-center items-center gap-y-8 py-20">
                    <h1 className="font-nastaleeqKasheeda text-4xl">کلاس میں شمولیت کا فارم</h1>
                    <h2 className="text-2xl mt-2">براہ کرم داخلہ کی درخواست کے لیے اپنے بچے کی معلومات درج کریں۔</h2>
                    <form className="font-nastaleeqRegular w-1/2 space-y-5">
                        <div className="flex gap-x-3 justify-center">
                            <div>
                                <input
                                    type="text"
                                    id="GuardianName"
                                    className="w-80 border rounded-md py-2 px-3 placeholder:text-2xl focus:outline-none focus:ring focus:ring-primary"
                        ...
                        <div className="flex w-full justify-center gap-x-3.5">
                            <div>
                                <input
                                    type="email"
                                    id="email"
                                    className="w-52 border rounded-md py-2 px-3 placeholder:text-2xl focus:outline-none focus:ring focus:ring-primary"
                                    placeholder="ای میل"
                                    dir="rtl"
                                />
                            </div>
                        ...
                        <div className="flex items-center">
                            <input
                                type="text"
                                id="address"
                                className="w-full border rounded-md mx-3.5 py-2 px-3 placeholder:text-2xl focus:outline-none focus:ring focus:ring-primary"
                                placeholder="پتہ"
                                dir="rtl"
                            />
                        </div>
                        ...
                        <div className="mt-6">
                            <button
                                type="submit"
                                className="w-1/3 bg-primary text-2xl text-white py-3 px-5 rounded-full hover:bg-secondary focus:outline-none focus:ring focus:ring-primary"
                            >
                                درخواست بھیجیں۔
                            </button>
                        </div>
